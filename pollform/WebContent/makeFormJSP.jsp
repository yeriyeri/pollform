...
<style type="text/css">
	#workspace_middle{ background-color: #F5F7F9; height: auto; margin: 0px 6% 6% 6%; padding-top: 6%; padding-right: 9%;}
	#workspace_middle div{ background-color: none; height: auto; width: 50%; margin-bottom: 100px; display: inline-block; text-align: right; text-align: text-top;}
...
<body class="index">
	...
	<div width="100%" height="100%" id="workspace_middle">
		...
		<!-- section2 시작 -->
		<section> 
			<form action="makeFormResult.html" >
			<%
			...
			%>
				<input type="submit" value="등록" id="makeJSP_btn" style="margin: 0% auto 0% auto">
			</form>
			<br/><br/><br/>
		</section>
		<!-- section2 끝--> 
